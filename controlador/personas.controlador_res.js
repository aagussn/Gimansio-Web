...
//me traigo con afiliacion y los planes vigentes 
exports.lstPerAfiPln = (req, res) => {	
	...
	var condition =	{
			...
			order: [  [{ model: db.afiliacion},'id', 'DESC' ] , [ db.afiliacion, { model: db.planes}, 'id', 'DESC' ]  ],
...
//me traigo con afiliacion y ultimo plan de la persona
